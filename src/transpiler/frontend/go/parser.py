...
class GoFrontend:
    ...
    def _parse_type(self, type_str: str) -> Type:
        if type_str == "int" or type_str == "int32" or type_str == "int64": return IntType
        if type_str == "float32" or type_str == "float64": return FloatType
    ...
    def _visit_expr(self, node: Node) -> Expr:
        ...
        elif node.type == "nil": return NullLiteral()
