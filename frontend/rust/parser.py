...
class RustFrontend:
    ...
    def _parse_type(self, type_str: str) -> Type:
        if type_str == "i32" or type_str == "i64": return IntType
        if type_str == "f32" or type_str == "f64": return FloatType
        if type_str == "bool": return BoolType
        if type_str == "String" or type_str == "&str": return StringType
        if type_str == "()": return VoidType
        return AnyType
